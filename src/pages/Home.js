...
export default function Home({ nav, setSelectedBiz, showToast }) {
    ...
    return (
      ...
      >
        <div
          ...
          style={{ background: CAT_BG[biz.category] || CAT_BG['Others'] }}
        >
          <span style={{ fontSize: 42 }}>
            {biz.category === 'Home Food'
              ? '🍱'
              : biz.category === 'Tiffin'
              ? '🥡'
              : biz.category === 'Mehendi'
              ? '🌸'
              : biz.category === 'Bakery'
              ? '🎂'
              : biz.category === 'Tuition'
              ? '📚'
              : biz.category === 'Beautician'
              ? '💄'
              : biz.category === 'Electrician'
              ? '⚡'
              : biz.category === 'Flowers'
              ? '💐'
              : biz.category === 'Fruits'
              ? '🍎'
              : biz.category === 'Freelance'
              ? '💻'
              : '🔧'}
          </span>
          {biz.is_verified && (
        ...
        <div className="biz-card-body">
          ...
          <p style={{ fontSize: 12, color: '#516B61', marginBottom: 0 }}>
  ...
  return (
    ...
    >
      {/* Hero header */}
      <div className="hero" style={{ paddingTop: 52, paddingBottom: 20 }}>
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
        ...
        >
          <div>
            <p style={{ fontSize: 11, opacity: 0.75, marginBottom: 3 }}>
              📍 Chennai, Tamil Nadu
            </p>
            <p style={{ fontSize: 18, fontWeight: 800, letterSpacing: -0.3 }}>
                  ...
                  >
                    ...
                    <div style={{ padding: '10px 12px' }}>
                      ...
                      >
                        ...
                        <span className="dist-badge" style={{ fontSize: 10 }}>
                          {biz.location_area}
                        </span>
                      </div>
                    </div>
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <div className="empty-sub">
              Owneur is growing fast! Be the first maker in your area.
            </div>
            <button
          ...
          nearby.map(function (biz) {
            return <BizCard key={biz.id} biz={biz} />;
          })
        )}
      </div>
